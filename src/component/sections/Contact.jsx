  ...
  return (
    <section id="contact" className='relative py-20 bg-black overflow-hidden'>
        <div className='absolute inset-0 overflow-hidden'>
            <div className='absolute top-1/4 left-1/4 w-96 h-96 bg-primary/20 opacity-30 rounded-full'/>
            ...
            <FadeIn delay={0}>
                <div className='text-center mb-16'>
                    ...
                    <p className='text-lg text-white/60 max-w-2xl mx-auto'>
                        Have a project in mide? Let's discuss how we can bring your ideas to life.
                    </p>
                </div>
            </FadeIn>
                        ...
                        <form onSubmit={handleSubmit} className='space-y-6'>
                            ...
                            <div>
                                ...
                                <input 
                                    ...
                                    onChange={handleChange}
                                    className='w-full px-4 py-3 bg-white/5 border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-300'
                                    placeholder='Your.email@emample.com'
                                    />

...
export const Testimonials = () => {
    ...
    const scrollToIndex = (index) =>{
        ...
        if (scrollcontainerRef.current){
            // use container width as page width for snapping
            ...
            <FadeIn delay={0}>
                <div className='text-center mb-16'>
                    <div className='inline-flex items-center gap-2 px-4 py-2 bg-primary/10 border border-primary/30 rounded-full mb-6'>
                        ...
                        <span className='tesm-sm text-primary font-medium tracking-wider uppercase'>Testimonials</span>
                    </div>
                    <h2 className='text-4xl lg:text-5xl font-normal text-white mb-4 max-w-xl mx-auto'>
                        Trusted by forward-thinking teams
                    </h2>
                    <p className='text-lg text-white/60 max-w-xl mx-auto'>
                        Empowering clients with design-driven, high-quality solution build for success.
                    </p>
                </div>
            </FadeIn>
                                                                    ...
                                                                    <div className='bg-black/60 rounded-xl p-4 shadow-lg'>
                                                                        <div className=''>
                                                                            <div className='text-2xl font-semibold text-primary mb-1'>
                                                                                {testimonialStat[index]?.value}
                                                                            </div>
                                                                            <div className='text-sm font-semibold text-gray-100'>
                                                                                {testimonialStat[index]?.label}
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                    ...
                    <div className='flex items-center justify-center gap-2 mt-10'>
                        {testimonials.map((_,index)=>(
                            ...
                            className={`transition-all duration-300 rounded-full ${index === currentIndex
                                ?'bg-white w-6 h-2'
                                : 'bg-white/30 w-2 h-2 hover:bg-white/5'
                                }`}
